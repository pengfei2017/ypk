...
$config['wap_site_url'] 		= '===url===/h5_web';
$config['chat_site_url'] 		= '===url===/chat';
$config['node_site_url'] 		= 'http://===node_ip===:8090';
$config['upload_site_url']		= '===url===/files/upload';
$config['resource_site_url']	= '===url===/files/resource';
...
//$config['fullindexer']['appname']   = 'xingsu';
$config['debug'] 			= false;
$config['default_store_id'] = '1';
//如果开始伪静态，这里设置为true
$config['url_model'] = false;
//如果医生开启二级域名绑定的，这里填写主域名如baidu.com
