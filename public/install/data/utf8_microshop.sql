...
CREATE TABLE `#__micro_goods` (
  ...
  `commend_goods_store_id` int(10) unsigned NOT NULL COMMENT '推荐商品医生编号',
...
CREATE TABLE `#__micro_store` (
  `microshop_store_id` int(11) unsigned NOT NULL AUTO_INCREMENT COMMENT '医生街医生编号',
  `shop_store_id` int(11) unsigned NOT NULL COMMENT '商城医生编号',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='微商城医生街表';
...
('microshop_seo_description', '多用户商城,微商城,随心看,个人秀,医生街'),
('microshop_seo_keywords', '多用户商城,微商城,随心看,个人秀,医生街,网上购物'),
