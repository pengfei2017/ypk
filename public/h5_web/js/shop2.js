...
$(function(){
    ...
    if($("input[name=sc_id]").val()!=''){
    	$.ajax({
    		url:ApiUrl+"/shop/index?key=4&page="+pagesize+"&curpage=1"+'&sc_id='+$("input[name=sc_id]").val()+"&type=doctor",
    		type:'get',
    		dataType:'json',
    	...
    	$.ajax({
    		url:ApiUrl+"/shop/index?key=4&page="+pagesize+"&curpage=1"+'&keyword='+$("#keyword").val()+'&area_info='+area_info+"&type=doctor",
    		type:'get',
    		dataType:'json',
    		success:function(result){
    			$("input[name=hasmore]").val(result.hasmore);
    ...
    $("select[name=page_list]").change(function(){
    	...
    	if(sc_id>0){
    		var url = ApiUrl+"/shop/index?key="+key+"&order="+order+"&page="+page+"&curpage="+curpage+"&sc_id="+sc_id+"&type=doctor";
    	}else{
    		var url = ApiUrl+"/shop/index?key="+key+"&order="+order+"&page="+page+"&curpage="+curpage+"&keyword="+keyword+"&type=doctor";
    	}
	...
	$('.keyorder').click(function(){
		...
		if(sc_id>0){
			var url = ApiUrl+"/shop/index?key="+curkey+"&order="+curorder+"&page="+page+"&curpage=1&sc_id="+sc_id+"&type=doctor";
		}else{
			var url = ApiUrl+"/shop/index?key="+curkey+"&order="+curorder+"&page="+page+"&curpage=1&keyword="+keyword+"&type=doctor";
		}
	...
	$('#serach_store').click(function(){
        ...
        location.href = WapSiteUrl+'/shop2.html?keyword='+keyword+'&area_info='+area_info;
    });
});