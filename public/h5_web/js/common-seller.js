...
function buildUrl(e, t) {
    switch (e) {
    case "keyword":
        return WapSiteUrl + "/js_template/product_list.html?keyword=" + encodeURIComponent(t);
    case "special":
        return WapSiteUrl + "/special.html?special_id=" + t;
    case "goods":
        return WapSiteUrl + "/js_template/product_detail.html?goods_id=" + t;
    case "url":
        return t
    }
    return WapSiteUrl
...
function getSearchName() {
    ...
    if (e == "") {
        if (getCookie("deft_key_value") == null) {
            $.getJSON(ApiUrl + "/index/search_hot_info",
            function(e) {
...
function getChatCount() {
    if ($("#header").find(".message").length > 0) {
        var e = getCookie("key");
        if (e !== null) {
            $.getJSON(ApiUrl + "/member_chat/get_msg_count", {
                key: e
            },
            function(e) {
                if (e.datas > 0) {
    ...
    $.extend($, {
        ...
        goodsClassSelected: function(options) {
            ...
            function _getGoodsClassList() {
                $.ajax({
                    type: "post",
                    url: ApiUrl + "/seller_goods_class/class_list",
                    data: {
                        gc_id: ASID,
                        deep:ASDEEP,
                        client:'mobile',
...
function buildUrl(type, data) {
    switch (type) {
        ...
        case 'pifa':
            return WapSiteUrl + '/js_template/product_list.html?searchtype=pifa&keyword=' + encodeURIComponent(data);
        case 'special':
