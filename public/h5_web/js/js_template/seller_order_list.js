...
$(function() {
    ...
    function t() {
        ...
        $.ajax({
            type: "post",
            url: ApiUrl + "/seller_order/order_list&page=" + page + "&curpage=" + curpage,
            data: {
                key: e,
                state_type: t,
                order_key: r
    ...
    function a(r,rt) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/seller_order/order_cancel",
            data: {
                order_id: r,
				reason:rt,
                key: e
    ...
    function i(orderid,price) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/seller_order/order_spay_price",
            data: {
                order_id: orderid,
				order_fee:price,
                key: e
    ...
    function n() {
        ...
        $.sDialog({
			...
			okFn:function(){
						...
						$.ajax({
							type: "post",
							url: ApiUrl + "/seller_order/order_deliver_send",
							data: {
