$(function() { 
    ...
    if (a) {
        $.ajax({
         ...
         var i = '<div class="member-info">' + '<a href="login.html" class="default-avatar" style="display:block;"></a>' + '<a href="login.html" class="to-login">点击登录</a>' + "</div>" + '<div class="member-collect"><span><a href="login.html"><i class="favorite-goods"></i>' + "<p>医生商品</p>" + '</a> </span><span><a href="login.html"><i class="favorite-store"></i>' + "<p>医生订单</p>" + '</a> </span><span><a href="login.html"><i class="goods-browse"></i>' + "<p>我的众包</p>" + "</a> </span></div>";
         $(".member-top").html(i);
    ...
    $("#quit").click(function() {
        ...
        $.ajax({
            type: "get",
            url: ApiUrl + "/seller_logout/index",
            data: {
                seller_name: a,
                key: e,
                client: i
            ...
            success: function(a) {
                if (a) {
                    ...
                    location.href = WapSiteUrl+ '/js_template/seller/login.html';
                }
            }
        })
    })
