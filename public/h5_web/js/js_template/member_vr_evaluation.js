$(function(){
    ...
    $.getJSON(ApiUrl + '/member_evaluate/vr', {key:key, order_id:order_id}, function(result){
        ...
        $('.btn-l').click(function(){
            ...
            $.ajax({//获取区域列表
                type:'post',
                url:ApiUrl+'/member_evaluate/save_vr',
                data:param,
                dataType:'json',
                async:false,
                success:function(result){
                    ...
                    window.location.href = WapSiteUrl + '/js_template/member/vr_order_list.html';
                }
            });
        });
    });
