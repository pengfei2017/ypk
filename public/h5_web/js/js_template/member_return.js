$(function(){
    ...
    load_class.loadInit({
        url:ApiUrl + '/member_return/get_return_list',
        getparam:{key :key },
        tmplid:'return-list-js_template',
        ...
        callback:function(){
            $('.delay-btn').click(function(){
                ...
                $.getJSON(ApiUrl+'/member_return/delay_form', {key:key,return_id:return_id}, function(result){
                    ...
                    $.sDialog({
                        ...
                        okFn:function(){
                            $.ajax({
                                type:'post',
                                url:ApiUrl+'/member_return/delay_post',
