...
$(function(){
    ...
    $.getJSON(ApiUrl + '/member_refund/refund_form',{key:key,order_id:getQueryString('order_id'),order_goods_id:getQueryString('order_goods_id')}, function(result) {
        result.datas.WapSiteUrl = WapSiteUrl;
        $('#order-info-container').html(template.render('order-info-js_template',result.datas));
        ...
        $('input[name="refund_pic"]').ajaxUploadImage({
            url : ApiUrl + "/member_refund/upload_pic",
            data:{key:key},
        ...
        $('.btn-l').click(function(){
            ...
            $.ajax({
                type:'post',
                url:ApiUrl+'/member_refund/refund_post',
                data:param,
                dataType:'json',
                async:false,
                success:function(result){
                    ...
                    window.location.href = WapSiteUrl + '/js_template/member/member_return.html';
                }
            });
        });
    });
