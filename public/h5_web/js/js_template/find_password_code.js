...
function send_sms(mobile, sec_val, sec_key) {
    $.getJSON(ApiUrl+'/connect/get_sms_captcha', {type:3,phone:mobile,sec_val:sec_val,sec_key:sec_key}, function(result){
...
function check_sms_captcha(mobile, captcha) {
    $.getJSON(ApiUrl + '/connect/check_sms_captcha', {type:3,phone:mobile,captcha:captcha }, function(result){
        if (!result.datas.error) {
