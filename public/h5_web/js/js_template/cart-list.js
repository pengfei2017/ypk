$(function (){
    ...
    if(!key){
        ...
        function initCartList(){
             $.ajax({
                url:ApiUrl+"/member_cart/cart_list",
                type:"post",
                dataType:"json",
                data:{key:key},
        ...
        function delCartList(cart_id){
            $.ajax({
                url:ApiUrl+"/member_cart/cart_del",
                type:"post",
        ...
        function editQuantity(self,type){
            ...
            $.ajax({
                url:ApiUrl+"/member_cart/cart_edit_quantity",
                type:"post",
        ...
        $('#cart-list-wp').on('click', ".check-out > a", function(){
            ...
            window.location.href = WapSiteUrl + "/js_template/order/buy_step1.html?ifcart=1&cart_id="+cart_id;
        });
...
function getGoods(goods_id, goods_num){
    ...
    $.ajax({
        type:'get',
        url:ApiUrl+'/goods/goods_detail&goods_id='+goods_id,
        dataType:'json',
        async:false,
        success:function(result){
            if (result.datas.error) {
