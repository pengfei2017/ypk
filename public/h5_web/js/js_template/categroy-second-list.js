$(function(){
	$.ajax({
		url:ApiUrl+"/goods_class&gc_id="+getQueryString("gc_id"),
		type:'get',
		dataType:'json',
		success:function(result){
			...
			$(".category-seciond-item").click(function (){
				...
				$.ajax({
					url:ApiUrl+"/goods_class&gc_id="+gc_id,
					type:'get',
					dataType:'json',
					success:function(result){
						...
						if(result){
							...
							$('.product_list').click(function(){	
								location.href = WapSiteUrl+"/js_template/product_list.html?gc_id="+$(this).attr('gc_id');
							});							
						}else{
							location.href = WapSiteUrl+"/js_template/product_list.html?gc_id="+gc_id;
						}		
					}
				});
			});
