...
$(function() {
    ...
    if (!e) {
        window.location.href = WapSiteUrl + "/js_template/seller/login.html"
    }
    ...
    function t() {
        ...
        $.ajax({
            type: "post",
            url: ApiUrl + "/seller_goods/goods_list&page=" + page + "&curpage=" + curpage,
            data: {
                key: e,
                goods_type: t,
                keyword: r,
            ...
            success: function(e) {
                ...
                var r = template.render("order-list-js_template", t);
                if (reset) {
                    reset = false;
                    $("#order-list").html(r)
                } else {
    ...
    function i(r) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/seller_goods/goods_unshow",
            data: {
            ...
            success: function(e) { 
                if (e.datas && e.datas == 1) {
                    $.sDialog({
						...
						content: "操作成功",
						okFn: function() {
							window.location.href = WapSiteUrl + "/js_template/seller/store_goods_list.html";
						}
					})
                } else {
                    $.sDialog({
    ...
    function s(r) {
        $.ajax({
            type: "post",
            url: ApiUrl + "/seller_goods/goods_show",
            data: {
                commonids: new Array(r),
                key: e
            },
    ...
    function d(r) {
       $.ajax({
            type: "post",
            url: ApiUrl + "/seller_goods/goods_drop",
            data: {
                commonids: new Array(r),
                key: e
            },
    ...
    function c() {
        ...
        location.href = WapSiteUrl + "/js_template/member/order_delivery.html?order_id=" + e
    }
