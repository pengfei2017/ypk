$(function() {
    ...
    $('#send').click(function(){
        ...
        $.ajax({
            type:'post',
            url:ApiUrl+"/member_account/modify_mobile_step2",
    ...
    $('#nextform').click(function(){
        ...
        if (auth_code) {
            $.ajax({
                type:'post',
                url:ApiUrl+"/member_account/modify_mobile_step3",
                ...
                success:function(result){
                    if(result.code == 200){
                    	...
                    	setTimeout("location.href = WapSiteUrl+'/js_template/member/member_mobile_bind.html'",2000);
                    }else{
                        errorTipsShow('<p>' + result.datas.error + '</p>');
                    }
                }
