$(function() {
        ...
        success:function(result){
            if(result.code == 200){
            	if (result.datas.state) {
            		...
            		location.href = WapSiteUrl+'/js_template/member/member_mobile_bind.html';
            	}
            }
        }
    });
    ...
    $('#send').click(function(){
        if($.sValid()){
            ...
            $.ajax({
                type:'post',
                url:ApiUrl+"/member_account/modify_password_step2",
    ...
    $('#nextform').click(function(){
        ...
        if (auth_code) {
            $.ajax({
                type:'post',
                url:ApiUrl+"/member_account/modify_password_step3",
                ...
                success:function(result){
                    if(result.code == 200){
                    	...
                    	setTimeout("location.href = WapSiteUrl+'/js_template/member/member_password_step2.html'",1000);
                    }else{
                        errorTipsShow('<p>' + result.datas.error + '</p>');
                    }
                }
