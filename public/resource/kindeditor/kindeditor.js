...
(function (window, undefined) {
    ...
    function _addParam(url, param) {
        return (url.indexOf('?') >= 0 ? url + '&' + param : url + '?' + param) + '&user_type=' + K.USER_TYPE;
    }
    ...
    K.options = {
        userType: '', //用户的文件上传和文件管理身份类型，可能用户在一个浏览器同时登录后台，前台或者商家中心三种身份，所以要加以区别身份
        designMode: true,
    ...
    _extend(KDialog, KWidget, {
        init: function (options) {
            ...
            self.closeIcon = K('<span class="ke-dialog-icon-close"></span>').click(closeBtn.click);
    ...
    KEditor.prototype = {
        ...
        hideDialog: function () {
            ...
            $("[id^='ui-id-']").remove(); //关闭对话框时删除所有的页面提示
            return self;
        },
