        ...
        <div class="title">
            ...
            <?php } else { ?>
                <div class="pic-type"><img
                        src="<?php echo UPLOAD_SITE_URL . '/' . $output['code_tit']['code_info']['pic']; ?>"/></div>
            <?php } ?>
        </div>
        <div class="left-ads">
            <?php if (!empty($output['code_act']['code_info']['pic'])) { ?>
                <a href="<?php echo $output['code_act']['code_info']['url']; ?>"
                   title="<?php echo $output['code_act']['code_info']['title']; ?>" target="_blank"> <img
                        ...
                        alt="<?php echo $output['code_act']['code_info']['title']; ?>"> </a>
            <?php } ?>
        </div>
            ...
            <ul>
                <?php if (is_array($output['code_category_list']['code_info']['goods_class']) && !empty($output['code_category_list']['code_info']['goods_class'])) { ?>
                    <?php foreach ($output['code_category_list']['code_info']['goods_class'] as $k => $v) { ?>
                        <li><a href="<?php echo getUrl('search/index', array('cate_id' => $v['gc_id'])); ?>"
                               title="<?php echo $v['gc_name']; ?>" target="_blank"><?php echo $v['gc_name']; ?></a>
                        </li>
                    <?php } ?>
                <?php } ?>
            </ul>
        ...
        <ul class="right-brand">
            ...
            <?php if (!empty($output['code_brand_list']['code_info']) && is_array($output['code_brand_list']['code_info'])) { ?>
                <?php foreach ($output['code_brand_list']['code_info'] as $key => $val) { ?>
                    <li>
                        <a href="<?php echo getUrl('shop/brand/list', array('brand' => $val['brand_id'])); ?>"
                           title="<?php echo $val['brand_name']; ?>"
                           target="_blank"><?php echo $val['brand_name']; ?></a>
                    </li>
                <?php } ?>
            <?php } ?>
            <li>
                <a href="<?php echo SHOP_SITE_URL; ?>/brand/index" title="" target="_blank">更多</a>
            </li>
        </ul>
                                ...
                                <li>
                                    <dl>
                                        <dt class="goods-name"><a target="_blank"
                                                                  href="<?php echo getUrl('goods/index', array('goods_id' => $v['goods_id'])); ?>"
                                    ...
                                    <?php if (is_array($output['code_adv']['code_info']) && !empty($output['code_adv']['code_info'])) { ?>
                                        <?php foreach ($output['code_adv']['code_info'] as $key => $val_) { ?>
                                            <?php if (is_array($val_) && !empty($val_)) { ?>
                                                <li><a href="<?php echo $val_['pic_url']; ?>"
                                                       title="<?php echo $val_['pic_name']; ?>" target="_blank"> <img
                                                            src="<?php echo UPLOAD_SITE_URL . '/' . $val_['pic_img']; ?>"
                                                            alt="<?php echo $val_['pic_name']; ?>"/></a></li>
                                            <?php } ?>
                                        <?php } ?>
                                    <?php } ?>
                                </ul>
                                    ...
                                    <dl>
                                        <?php if (!empty($val['pic_list']['11']['pic_name'])) { ?>
                                            <dt class="banner-name"><a
                                                    href="<?php echo $val['pic_list']['11']['pic_url']; ?>"
                                                    title="<?php echo $val['pic_list']['11']['pic_name']; ?>"
                                                    target="_blank"> <?php echo $val['pic_list']['11']['pic_name']; ?></a>
                                            </dt>
                                        <?php } ?>
                                        <dd class="banner-thumb"><a
                                                href="<?php echo $val['pic_list']['11']['pic_url']; ?>"
                                                title="<?php echo $val['pic_list']['11']['pic_name']; ?>" class="a1"
                                                target="_blank"> <img
                                                    src="<?php echo UPLOAD_SITE_URL; ?>/shop/common/loading.gif"
                                                    alt="<?php echo $val['pic_list']['11']['pic_name']; ?>"
                                                    data-url="<?php echo UPLOAD_SITE_URL . '/' . $val['pic_list']['11']['pic_img']; ?>"
                                                    rel="lazy"/></a></dd>
                                    </dl>
                                </li>
                                <li>
                                    <dl>
                                        <?php if (!empty($val['pic_list']['31']['pic_name'])) { ?>
                                            <dt class="banner-name"><a
                                                    href="<?php echo $val['pic_list']['31']['pic_url']; ?>"
                                                    title="<?php echo $val['pic_list']['31']['pic_name']; ?>"
                                                    target="_blank"> <?php echo $val['pic_list']['31']['pic_name']; ?></a>
                                            </dt>
                                        <?php } ?>
                                        <dd class="banner-thumb"><a
                                                href="<?php echo $val['pic_list']['31']['pic_url']; ?>"
                                                title="<?php echo $val['pic_list']['31']['pic_name']; ?>" class="a1"
                                                target="_blank"> <img
                                                    src="<?php echo UPLOAD_SITE_URL; ?>/shop/common/loading.gif"
                                                    alt="<?php echo $val['pic_list']['31']['pic_name']; ?>"
                                                    data-url="<?php echo UPLOAD_SITE_URL . '/' . $val['pic_list']['31']['pic_img']; ?>"
                                                    rel="lazy"/></a></dd>
                                    </dl>
                                </li>
                                <li>
                                    <dl>
                                        <?php if (!empty($val['pic_list']['33']['pic_name'])) { ?>
                                            <dt class="banner-name"><a
                                                    href="<?php echo $val['pic_list']['33']['pic_url']; ?>"
                                                    title="<?php echo $val['pic_list']['33']['pic_name']; ?>"
                                                    target="_blank"> <?php echo $val['pic_list']['33']['pic_name']; ?></a>
                                            </dt>
                                        <?php } ?>
                                        <dd class="banner-thumb"><a
                                                href="<?php echo $val['pic_list']['33']['pic_url']; ?>"
                                                title="<?php echo $val['pic_list']['33']['pic_name']; ?>" class="a1"
                                                target="_blank"> <img
                                                    src="<?php echo UPLOAD_SITE_URL; ?>/shop/common/loading.gif"
                                                    alt="<?php echo $val['pic_list']['33']['pic_name']; ?>"
                                                    data-url="<?php echo UPLOAD_SITE_URL . '/' . $val['pic_list']['33']['pic_img']; ?>"
                                                    rel="lazy"/></a></dd>
                                    </dl>
                                </li>
                                <li>
                                    <dl>
                                        <?php if (!empty($val['pic_list']['12']['pic_name'])) { ?>
                                            <dt class="banner-name"><a
                                                    href="<?php echo $val['pic_list']['12']['pic_url']; ?>"
                                                    title="<?php echo $val['pic_list']['12']['pic_name']; ?>"
                                                    target="_blank"> <?php echo $val['pic_list']['12']['pic_name']; ?></a>
                                            </dt>
                                        <?php } ?>
                                        <dd class="banner-thumb"><a
                                                href="<?php echo $val['pic_list']['12']['pic_url']; ?>"
                                                title="<?php echo $val['pic_list']['12']['pic_name']; ?>" class="a1"
                                                target="_blank"> <img
                                                    src="<?php echo UPLOAD_SITE_URL; ?>/shop/common/loading.gif"
                                                    alt="<?php echo $val['pic_list']['12']['pic_name']; ?>"
                                                    data-url="<?php echo UPLOAD_SITE_URL . '/' . $val['pic_list']['12']['pic_img']; ?>"
                                                    rel="lazy"/></a></dd>
                                    </dl>
                                </li>
                                <li>
                                    <dl>
                                        <?php if (!empty($val['pic_list']['32']['pic_name'])) { ?>
                                            <dt class="banner-name"><a
                                                    href="<?php echo $val['pic_list']['32']['pic_url']; ?>"
                                                    title="<?php echo $val['pic_list']['32']['pic_name']; ?>"
                                                    target="_blank"> <?php echo $val['pic_list']['32']['pic_name']; ?></a>
                                            </dt>
                                        <?php } ?>
                                        <dd class="banner-thumb"><a
                                                href="<?php echo $val['pic_list']['32']['pic_url']; ?>"
                                                title="<?php echo $val['pic_list']['32']['pic_name']; ?>" class="a1"
                                                target="_blank"> <img
                                                    src="<?php echo UPLOAD_SITE_URL; ?>/shop/common/loading.gif"
                                                    alt="<?php echo $val['pic_list']['32']['pic_name']; ?>"
                                                    data-url="<?php echo UPLOAD_SITE_URL . '/' . $val['pic_list']['32']['pic_img']; ?>"
                                                    rel="lazy"/></a></dd>
                                    </dl>
                                </li>
                                <li>
                                    <dl>
                                        <?php if (!empty($val['pic_list']['34']['pic_name'])) { ?>
                                            <dt class="banner-name"><a
                                                    href="<?php echo $val['pic_list']['34']['pic_url']; ?>"
                                                    title="<?php echo $val['pic_list']['34']['pic_name']; ?>"
                                                    target="_blank"> <?php echo $val['pic_list']['34']['pic_name']; ?></a>
                                            </dt>
                                        <?php } ?>
                                        <dd class="banner-thumb"><a
                                                href="<?php echo $val['pic_list']['34']['pic_url']; ?>"
                                                title="<?php echo $val['pic_list']['34']['pic_name']; ?>" class="a1"
                                                target="_blank"> <img
                                                    alt="<?php echo $val['pic_list']['34']['pic_name']; ?>"
                                                    src="<?php echo UPLOAD_SITE_URL . '/' . $val['pic_list']['34']['pic_img']; ?>"
                                                    rel="lazy"/></a></dd>
                                    </dl>
                                </li>
                            </ul>
