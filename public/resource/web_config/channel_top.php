  ...
  <div class="channel-category">
    <ul class="menu">
      ...
      <li cat_id="<?php echo $val['gc_parent']['gc_id'];?>" class="<?php echo $i%2==1 ? 'odd':'even';?>" <?php if($i>6){?>style="display:none;"<?php }?>>
        ...
        <?php } ?>
        <h4><a href="<?php echo getUrl('search/index',array('cate_id'=> $val['gc_parent']['gc_id']));?>"><?php echo $val['gc_parent']['gc_name'];?></a></h4>
        ...
        <div class="sub-class" cat_menu_id="<?php echo $val['gc_parent']['gc_id'];?>" style="display:none;">
          <dl>
            ...
            <dd class="goods-class"> <a href="<?php echo getUrl('search/index',array('cate_id'=> $v['gc_id']));?>"><?php echo $v['gc_name'];?></a> </dd>
            <?php } ?>
            <?php } ?>
          </dl>
        </div>
