    ...
    <div class="left-sidebar">
        ...
        <div class="left-ads">
            <?php if (!empty($output['code_channel_act']['code_info']['pic'])) { ?>
                <a href="<?php echo $output['code_channel_act']['code_info']['url']; ?>"
                   title="<?php echo $output['code_channel_act']['code_info']['title']; ?>" target="_blank"> <img
                        src="<?php echo UPLOAD_SITE_URL . '/' . $output['code_channel_act']['code_info']['pic']; ?>"
                        alt="<?php echo $output['code_channel_act']['code_info']['title']; ?>"> </a>
            <?php } ?>
        </div>
    </div>
                                ...
                                <li>
                                    <dl>
                                        ...
                                        <dd class="goods-price">
                                            <em><?php echo ncPriceFormatForList($v['goods_price']); ?></em></dd>
                                    </dl>
                                </li>
                            <?php } ?>
                        </ul>
    ...
    <div class="right-sidebar">
        <div class="picture">
            <?php if (!empty($output['code_adv_a']['code_info']['pic'])) { ?>
                <a href="<?php echo $output['code_adv_a']['code_info']['pic_url']; ?>"
                   title="<?php echo $output['code_adv_a']['code_info']['pic_name']; ?>" target="_blank">
        ...
        <div class="picture">
            <?php if (!empty($output['code_adv_b']['code_info']['pic'])) { ?>
                <a href="<?php echo $output['code_adv_b']['code_info']['pic_url']; ?>"
                   title="<?php echo $output['code_adv_b']['code_info']['pic_name']; ?>" target="_blank">
        ...
        <div class="picture">
            <?php if (!empty($output['code_adv_c']['code_info']['pic'])) { ?>
                <a href="<?php echo $output['code_adv_c']['code_info']['pic_url']; ?>"
                   title="<?php echo $output['code_adv_c']['code_info']['pic_name']; ?>" target="_blank">
