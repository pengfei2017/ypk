...
//布局换色设置
    ...
    $('div[data-param^="map-"]').find('i').click(function () {
        ...
        if ($this.parent().hasClass('selected')) {
            $.getJSON(ADMIN_SITE_URL + '/common/common_operations', {type: 'del', value: _value}, function (data) {
                if (data) {
            ...
            $.getJSON(ADMIN_SITE_URL + '/common/common_operations', {type: 'add', value: _value}, function (data) {
                if (data) {
    ...
    if ($.cookie('commonPendingMatters') == null) {
        $.ajax({
            url: ADMIN_SITE_URL + '/common/ajax_pending_matters',
            async: false,
