...
class web_configModel extends Model
{
    ...
    {
        $style_data = array(
            'red' => getLang('web_config_style_red'),
            'pink' => getLang('web_config_style_pink'),
            'orange' => getLang('web_config_style_orange'),
            'green' => getLang('web_config_style_green'),
            'blue' => getLang('web_config_style_blue'),
            'purple' => getLang('web_config_style_purple'),
            'brown' => getLang('web_config_style_brown'),
            'default' => getLang('web_config_style_default')
        );
