...
class seoModel extends Model{
    ...
    public function type($type){
        ...
        foreach ($this->seo as $key=>$value) {
            $this->seo[$key] = str_replace(array('{sitename}'),array(getConfig('site_name')),$value);
        }
        return $this;
    }
    ...
    public function show(){
        ...
        Tpl::output('html_title',$this->seo['title'] ? $this->seo['title'] : getConfig('site_name'));
        Tpl::output('seo_keywords',$this->seo['keywords'] ? $this->seo['keywords'] : getConfig('site_name'));
        Tpl::output('seo_description',$this->seo['description'] ? $this->seo['description'] : getConfig('site_name'));
    }
