...
class voucherModel extends Model
{
    ...
    {
        $info = read_db_cache($member_id, 'm_voucher', 'voucher_count');
        if (empty($info['voucher_count']) && $info['voucher_count'] !== 0) {
            ...
            write_db_cache($member_id, array('voucher_count' => $voucher_count), 'm_voucher');
        } else {
    ...
    public function editVoucher($data, $condition, $member_id = 0)
    {
        ...
        if ($result && $member_id > 0) {
            write_db_cache($member_id, array('voucher_count' => null), 'm_voucher');
        }
        return $result;
    }
    ...
    public function exchangeVoucher($template_info, $member_id, $member_name = '')
    {
        ...
        if ($result) {
            ...
            write_db_cache($member_id, array('voucher_count' => array('exp', 'voucher_count+1')), 'm_voucher');
