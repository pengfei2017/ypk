...
class order_bookLogic {
    ...
    public function getOrderBookInfo($order_info) {
            ...
            if (empty($book_list[0]['book_pay_time'])) {
                ...
                if ($book_list[0]['book_end_time'] > TIMESTAMP) {
                    ...
                    if ($order_info['order_state'] == ORDER_STATE_CANCEL) {
                        ...
                        $book_list[0]['book_operate'] = '<a class="ncm-btn ncm-btn-orange fr mr15" href="'.getUrl('shop/buy/pay',array('pay_sn'=>$pay_sn)).'">付款</a>';
            ...
            if (empty($book_list[0]['book_pay_time'])) {
                ...
                if ($book_list[0]['book_end_time'] > TIMESTAMP) {
                    ...
                    if ($order_info['order_state'] == ORDER_STATE_CANCEL) {
                        ...
                        $_fen = ceil(($book_list[0]['book_end_time'] - TIMESTAMP)/60);
                        $book_list[0]['book_state'] = '须在'.$_fen.'分钟内付款';
                        $book_list[0]['book_operate'] = '<a class="ncm-btn ncm-btn-orange fr mr15" href="'.getUrl('shop/buy/buy',array('pay_sn'=>$pay_sn)).'">付款</a>';
                        $order_info['if_buyer_pay'] = true;
                ...
                if (empty($book_list[1]['book_pay_time'])) {
                    ...
                    if ($book_list[1]['book_end_time'] > TIMESTAMP) {
                        ...
                        if ($order_info['order_state'] == ORDER_STATE_CANCEL) {
                            ...
                            $book_list[1]['book_operate'] = '<a class="ncm-btn ncm-btn-orange fr mr15" href="'.getUrl('shop/buy/buy',array('pay_sn'=>$pay_sn)).'">付款</a>';
        ...
        return queue_callback(true, '', $order_info);
    }
    ...
    public function changeBookOrderReceivePay($order_info,$post) {
        ...
        return queue_callback($update,'更新订单预定信息失败');
    }
