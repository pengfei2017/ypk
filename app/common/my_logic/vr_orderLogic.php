...
class vr_orderLogic
{
    ...
    public function changeOrderStateCancel($order_info, $role, $msg, $if_queue = true)
    {
        ...
        try {
            ...
            return queue_callback(true, '更新成功');
    ...
    public function changeOrderStatePay($order_info, $role, $post)
    {
        try {
            ...
            if (!$update) {
                throw new \Exception(getLang('nc_common_save_fail'));
            }
            //发放兑换码
            ...
            $param['param'] = array(
                ...
                'order_url' => getUrl('shop/member_vr_order/show_order', array('order_id' => $order_info['order_id']))
            );
