...
class GoodsClassTagLogic extends Model
{
    ...
    {
        return deleteAll('Ypk\Models\GoodsClassTag', $condition);
    }
    ...
    public function tagAdd($param)
    {
        ...
        return insertAll('Ypk\Models\GoodsClassTag', $insert_array);
    }
    ...
    public function updateTag($param)
    {
        ...
        if (is_array($param)) {
            ...
            $goodsclasstag = GoodsClassTag::findFirst('gc_tag_id = ' . $param['gc_tag_id']);
            if ($goodsclasstag != false) {
                if ($goodsclasstag->save($tmp) == false) {
                    return false;
                }
            }
        } else {
