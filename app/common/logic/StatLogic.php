...
class StatLogic extends Model {
     ...
     * @internal param array $condition 条件
     * @internal param int $limit 限制
     * @internal param bool $lock 是否锁定
     * @return array
     */
     ...
     * @internal param string $group 分组
     * @internal param string $order 排序
     * @internal param int $limit 限制
     * @internal param int $page 分页
     */
