...
class PBundlingLogic extends Model
{
    const STATE1 = 1;       // 开启
    const STATE0 = 0;       // 关闭
    ...
    {
        return read_file_cache($goods_id, false, null, 'goods_bundling/');
    }
    ...
    {
        return write_file_cache($goods_id, $array, null, 'goods_bundling/');
    }
    ...
    {
        return delete_file_cache($goods_id, 'goods_bundling/');
    }
}