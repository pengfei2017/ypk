...
class ConnectApiLogic extends Model
{
    ...
    public function getWxOAuth2Url()
    {
        ...
        $api_url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid=' . $weixin_appid .
            '&redirect_uri=' . urlencode(MOBILE_SITE_URL . '/connect/index') .
    ...
    {
        $model_mb_user_token = new MbUserTokenLogic();
     ...
     * @internal param string $api_type
     */
    ...
    public function getSinaOAuth2Url($sina_type = '')
    {
        ...
        require_once(RESOURCE_SITE_URL . DS . 'api' . DS . 'sina' . DS . 'saetv2.ex.class.php');
    ...
    public function getQqOAuth2Url($qq_type = '')
    {
        ...
        require_once(RESOURCE_SITE_URL . DS . 'api' . DS . 'qq' . DS . 'oauth.qq.class.php');
