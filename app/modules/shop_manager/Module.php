...
namespace Ypk\Modules\ShopManager;
...
define('MODULE_NAME', 'shop_manager');
...
class Module implements ModuleDefinitionInterface
{
    ...
    public function registerAutoloaders(DiInterface $di = null)
    {
        ...
        $loader->registerNamespaces([
            'Ypk\Modules\ShopManager\Controllers' => __DIR__ . '/controllers/',
            'Ypk\Modules\ShopManager\Models' => __DIR__ . '/models/'
        ]);
