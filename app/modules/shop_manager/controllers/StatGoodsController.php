...
class StatGoodsController extends ControllerBase
{
    private $links = array(
        array('url' => array('module' => 'shop_manager', 'controller' => 'stat_goods', 'action' => 'pricerange'), 'lang' => 'stat_goods_pricerange'),
        array('url' => array('module' => 'shop_manager', 'controller' => 'stat_goods', 'action' => 'hotgoods'), 'lang' => 'stat_hotgoods'),
        array('url' => array('module' => 'shop_manager', 'controller' => 'stat_goods', 'action' => 'goods_sale'), 'lang' => 'stat_goods_sale'),
    );
...
//        Tpl::showpage('stat.goods.prange');
        $this->view->pick('stat_goods/stat_goods_prange');
    }

    /**
     * 热卖商品
     */
    public function hotgoodsAction()
    {
        if (!$this->search_arr['search_type']) {
            $this->search_arr['search_type'] = 'day';
        }
...
//        Tpl::showpage('stat.goods.hotgoods');
        $this->view->pick('stat_goods/stat_goods_hotgoods');
    }

    /**
     * 热卖商品列表
     */
    public function hotgoods_listAction()
    {
        $model = Model('stat');
        switch ($_GET['type']) {
            case 'goodsnum':
...
//        Tpl::showpage('stat.goods.hotgoods.list','null_layout');
        ...
        $this->view->pick('stat_goods/stat_goods_hotgoods_list');
    }

    /**
     * 商品销售明细
     */
    public function goods_saleAction()
    {
        if (!$this->search_arr['search_type']) {
            $this->search_arr['search_type'] = 'day';
        }
...
//            Tpl::showpage('stat.goodssale');
            $this->view->pick('stat_goods/stat_goodssale');
        }
    }
