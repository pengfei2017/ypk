...
class StatIndustryController extends ControllerBase
{
    private $links = array(
        array('url' => array('module' => 'shop_manager', 'controller' => 'stat_industry', 'action' => 'scale'), 'lang' => 'stat_industryscale'),
        array('url' => array('module' => 'shop_manager', 'controller' => 'stat_industry', 'action' => 'rank'), 'lang' => 'stat_industryrank'),
        array('url' => array('module' => 'shop_manager', 'controller' => 'stat_industry', 'action' => 'price'), 'lang' => 'stat_industryprice'),
        array('url' => array('module' => 'shop_manager', 'controller' => 'stat_industry', 'action' => 'general'), 'lang' => 'stat_industrygeneral'),
    );
...
//        import('function.datehelper');
    ...
    public function scaleAction()
    {
        ...
        $this->view->pick('stat_industry/stat_industry_scale');
     ...
     * 行业规模列表
     */
    public function scale_listAction()
    {
        //获得子分类ID
...
//            Tpl::showpage('stat.linelabels','null_layout');
            ...
            $this->view->pick('stat_industry/stat_linelabels');
        }
    }
...
//        Tpl::showpage('stat.industry.rank');
        $this->view->pick('stat_industry/stat_industry_rank');
    }
    ...
    public function priceAction()
    {
        ...
        $field = '1';
        $pricerange_arr = ($t = trim(getConfig('stat_pricerange'))) ? unserialize($t) : '';
        if ($pricerange_arr) {
...
//        Tpl::showpage('stat.industry.price');
        $this->view->pick('stat_industry/stat_industry_price');
    }
...
//        Tpl::showpage('stat.industry.general');
        $this->view->pick('stat_industry/stat_industry_general');
    }

    /**
     * 概况总览
     */
    public function general_listAction()
    {
        //获得子分类ID
        $gc_childid = $gc_childarr = array();
        if ($this->choose_gcid > 0) {//如果进行了分类搜索，则统计该分类下的子分类
     ...
     * 输出概况总览XML数据
     */
    public function get_general_xmlAction()
    {
        //获得子分类ID
        $gc_childid = $gc_childarr = array();
        if ($this->choose_gcid > 0) {//如果进行了分类搜索，则统计该分类下的子分类
