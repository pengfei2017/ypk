...
class ArticleController extends BaseArticleController
{
    ...
    {
        parent::initialize();
        getTranslation('home_article_index,home_layout');
    ...
    public function indexAction()
    {
        ...
        showMessage(getLang('article_article_not_found'), '', 'html', 'error');//'没有符合条件的文章'
    }
...
//        Tpl::showpage('article_list');
        $this->view->render('article', 'article_list');
        $this->view->disable();
    }
    ...
    public function showAction()
    {
        ...
        $nav_link = array(
            ...
            array(
                'title' => $article_class['ac_name'],
                'link' => getUrl('member/article/article', array('ac_id' => $article_class['ac_id']))
            ),
            array(
        ...
        $this->view->render('article', 'article_show');
        $this->view->disable();
    }
}
