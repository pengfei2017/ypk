...
class PredepositController extends BaseMemberController
{
    ...
    {
        $menu_array = array(
            array('menu_key' => 'loglist', 'menu_name' => '账户余额', 'menu_url' => getUrl('member/predeposit/pd_log_list')),
            array('menu_key' => 'recharge_list', 'menu_name' => '充值明细', 'menu_url' => getUrl('member/predeposit/index')),
            array('menu_key' => 'cashlist', 'menu_name' => '余额提现', 'menu_url' =>getUrl('member/predeposit/pd_cash_list')),
            array('menu_key' => 'rcb_log_list', 'menu_name' => '充值卡余额', 'menu_url' => getUrl('member/predeposit/rcb_log_list')),
        );
        switch ($menu_type) {
            case 'rechargeinfo':
