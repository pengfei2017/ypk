...
class MemberSecurityController extends BaseMemberController
{
    ...
    public function send_bind_emailOp()
    {
        ...
        $verify_url = getUrl('member/login/bind_email', array('uid' => $uid, 'hash' => md5($seed)));
    ...
    private function profile_menu($menu_type, $menu_key = '')
    {
        ...
        switch ($menu_type) {
            ...
            case 'modify_pwd':
                $menu_array = array(
                    array('menu_key' => 'index', 'menu_name' => '账户安全', 'menu_url' => getUrl('shop/member_security/index')),
                    array('menu_key' => 'modify_pwd', 'menu_name' => '修改登录密码', 'menu_url' => getUrl('shop/member_security/modify_pwd')),
                );
                break;
            case 'modify_email':
                $menu_array = array(
