...
$lang['default_store_logo']    = '默认医生标志';
...
$lang['image_dir_type_0']	= '按照文件名存放 (例:/医生id/图片)';
$lang['image_dir_type_1']	= '按照年份存放 (例:/医生id/年/图片)';
$lang['image_dir_type_2']	= '按照年月存放 (例:/医生id/年/月/图片)';
$lang['image_dir_type_3']	= '按照年月日存放 (例:/医生id/年/月/日/图片)';
$lang['image_width']	= '宽';
$lang['image_height']	= '高';
...
$lang['open_rewrite_tips']      ='启用伪静态可以提高搜索引擎抓取<br/>如果您使用的是Apache服务器，启用前，清醒确保已开启Apache服务器的rewrite.module功能模组，并将商城目录下的"htaccess.txt"档案重命名为".htaccess"。';
...
$lang['promotion_notice'] = '启用商品促销功能后，商家可以通过限时打折、满即送、优惠套装、推荐展位、加价购、预售商品、F码商品活动，对医生商品进行促销';
...
$lang['voucher_allow_notice'] = '代金券功能、积分功能、积分中心启用后，商家可以申请代金券活动；会员积分达到要求时可以在积分中心兑换代金券；<br>拥有代金券的会员可在代金券所属医生内购买商品时，选择使用而得到优惠';
...
$lang['site_bank_account_notice']           = '用半角逗号","分隔项目，用半角冒号":"分隔标题和内容，例："银行:中国银行,币种:人民币,账号:xxxxxxxxxxx,姓名:xingsu,开户行:中国银行北京分行"';
...
$lang['if_smtp_authentication']  = '使用SMTP协议发送的邮件地址，如 xingsu@163.com';
$lang['smtp_user_name']          = 'SMTP 身份验证用户名';
$lang['smtp_user_name_tip']      = '如 xingsu，如果使用163或126邮箱，填写完整，如 xingsu@163.com';
...
$lang['setting_store_creditrule']        = '医生信用';
...
$lang['user_info_clear']         = '会员信息清除，其拥有的医生和商品也会被清除，您确定要清除吗?';
...
$lang['share_notice'] 	= '开启站外分享功能并设置站外分享绑定的相应接口后，SNS分享医生和商品信息功能中将可以使用站外分享信息功能';
...
$lang['seo_set_tips4'] 	= '医生名称 {shopname}，（应用范围：医生页）';
$lang['seo_set_tips5'] 	= '关键词 {key}，（应用范围：商品关键词、文章关键词、医生关键词）';
$lang['seo_set_tips6'] 	= '简单描述 {description}，（应用范围：商品描述、文章摘要、医生关键词）';
