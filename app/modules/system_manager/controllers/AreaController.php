...
//        Tpl::showpage('area.index');
        $this->view->pick('area/area_index');
    }
    ...
    public function get_xmlAction()
    {
        ...
        foreach ($list as $k => $info) {
            ...
            $operation_detail .= "<li><a href=".getUrl('system_manager/area/edit',array('area_id'=>$info['area_id'])).">编辑地区</a></li>";
            if ($info['area_deep'] <= 3) {
                $operation_detail .= "<li><a href=".getUrl('system_manager/area/add',array('parent_id'=>$info['area_id'])).">新增下级</a></li>";
...
//        Tpl::showpage('area.add');
    ...
    public function saveAction()
    {
        ...
        if ($result) {
            showMessage('操作成功', $_GET['area_id'] ? getUrl('system_manager/area/index') : '');
        } else {
