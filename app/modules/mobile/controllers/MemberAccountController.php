...
class MemberAccountController extends MobileMemberController
{
     ...
     * 初次绑定手机第一步
     */
    public function bind_mobile_step1Action()
    {
     ...
     * 初次绑定手机第二步 - 验证短信码
     */
    public function bind_mobile_step2Action()
    {
     ...
     */
    public function get_mobile_infoAction()
    {
        $data = array();
     ...
     * 检测是否设置了支付密码
     */
    public function get_paypwd_infoAction()
    {
        $data = array();
     ...
     */
    public function modify_mobile_step2Action()
    {
     ...
     */
    public function modify_password_step2Action()
    {
        $this->_send_bind_mobile_msg();
    }
     ...
     */
    public function modify_paypwd_step2Action()
    {
        $this->_send_bind_mobile_msg();
    }
     ...
     * 更改绑定手机 第三步 - 验证短信码
     */
    public function modify_mobile_step3Action()
    {
        if (!$_POST['auth_code'] || !preg_match('/^\d{6}$/', $_POST['auth_code'])) {
            output_error('请正确输入短信验证码');
        }
     ...
     * 更改密码 第三步 - 验证短信码
     */
    public function modify_password_step3Action()
    {
     ...
     * 更改支付密码 第三步 - 验证短信码
     */
    public function modify_paypwd_step3Action()
    {
        $this->_modify_pwd_check_vcode();
    }
     ...
     * 更改密码 第四步 - 检查是否有权修改密码
     */
    public function modify_password_step4Action()
    {
     ...
     */
    public function modify_paypwd_step4Action()
    {
        $this->_modify_pwd_limit_check();
        output_data('1');
    }
     ...
     * 更改密码 第五步 - 保存新密码到数据库
     */
    public function modify_password_step5Action()
    {
     ...
     */
    public function modify_paypwd_step5Action()
    {
     ...
     * 验证输入支付密码是否正确
     */
    public function check_paypwdAction()
    {
        if (!$_POST['password']) {
