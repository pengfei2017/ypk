...
class MemberRedpacketController extends MobileMemberController {
    private $redpacket_state_arr;

    public function initialize() {
        parent::initialize();
        //判断系统是否开启红包功能
        if (getConfig('redpacket_allow') != 1){
     ...
     * 我的红包列表
     */
    public function redpacket_listAction(){
        $param = $_POST;
        $model_redpacket = Model('redpacket');
        //更新红包过期状态
