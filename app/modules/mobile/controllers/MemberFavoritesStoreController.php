...
class MemberFavoritesStoreController extends MobileMemberController {
     ...
     * 收藏列表
     */
    public function favorites_listAction() {
     ...
     * 添加收藏
     */
    public function favorites_addAction() {
     ...
     * 删除收藏
     */
    public function favorites_delAction() {
        $fav_id = intval($_POST['store_id']);
        if ($fav_id <= 0) {
            output_error('参数错误');
        }
