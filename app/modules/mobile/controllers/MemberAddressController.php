...
class MemberAddressController extends MobileMemberController {
     ...
     * 地址详细信息
     */
    public function address_infoAction() {
     ...
     * 新增地址
     */
    public function address_addAction() {
     ...
     * 编辑地址
     */
    public function address_editAction() {
        $address_id = intval($_POST['address_id']);
