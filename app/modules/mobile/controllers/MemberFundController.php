...
class MemberFundController extends MobileMemberController {
     ...
     * 预存款日志列表
     */
    public function predepositlogAction(){
     ...
     * 充值明细
     */
    public function pdrechargelistAction(){
        $where = array();
     ...
     * 提现记录
     */
    public function pdcashlistAction(){
        $where = array();
     ...
     * 预存款提现记录详细
     */
    public function pdcashinfoAction(){
        $param = $_GET;
