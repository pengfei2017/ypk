...
class SellerGoodsController extends MobileSellerController {
     ...
     * 商品详细信息
     */
     public function goods_infoAction() {
     ...
     * 商品详细信息
     */
    public function goods_image_infoAction() {
        $common_id = $_POST['goods_commonid'];
        $model_goods = Model('goods');
    ...
    public function goods_showAction() {
        if ($this->store_info['store_state'] != 1) {
            output_error('医生正在审核中或已经关闭，不能上架商品');
        }
     ...
     * 商品删除
     */
    public function goods_dropAction() {
