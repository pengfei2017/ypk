...
class MemberVoucherController extends MobileMemberController {

    public function initialize() {
        parent::initialize();
        // 判断系统是否开启代金券功能
        if (intval(getConfig('voucher_allow')) !== 1) {
     ...
     * 我的代金券列表
     */
    public function voucher_listAction() {
        $param = $_POST;
     ...
     * 卡密领取代金券
     */
    public function voucher_pwexAction()
    {
        $param = $_POST;
     ...
     * 免费领取代金券
     */
    public function voucher_freeexAction() {
        $param = $_POST;
