...
class SellerStatController extends MobileSellerController
{
    ...
    public function ordersamountAction()
    {
     ...
     * 客单价统计
     */
    public function perguestpriceAction()
    {
        $model_stat = Model('stat');
        $where = array();
        $where['store_id'] = $this->store_info['store_id'];
    ...
    public function goodsamountAction()
    {
        $this->goodssales('goodsamount');
    }

    public function goodsnumAction()
    {
     ...
     * 商品流量TOP10
     */
    public function goodsflowAction()
    {
        $topnum = 10;
        //确定统计分表名称
        $last_num = $this->store_info['store_id'] % 10; //获取医生ID的末位数字
    ...
    public function areasalesamountAction()
    {
        $this->areasales('ordersamount');
    }

    public function areasalesnumAction()
    {
        $this->areasales('ordersnum');
    }

    public function areamembernumAction()
    {
