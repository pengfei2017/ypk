...
class MemberCartController extends MobileMemberController {
     ...
     * 购物车列表
     */
    public function cart_list_oldAction() {
        $model_cart = Model('cart');
     ...
     * 购物车添加
     */
    public function cart_addAction() {
     ...
     * 购物车删除
     */
    public function cart_delAction() {
     ...
     * 更新购物车购买数量
     */
    public function cart_edit_quantityAction() {
     ...
     */
    public function cart_batchaddAction(){
        $param = $_POST;
