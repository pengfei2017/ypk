...
class MemberInvoiceController extends MobileMemberController {
     ...
     * 发票信息列表
     */
    public function invoice_listAction() {
     ...
     * 发票信息删除
     */
    public function invoice_delAction() {
     ...
     * 发票信息添加
     */
    public function invoice_addAction() {
        $model_invoice = Model('invoice');
     ...
     * 发票内容列表
     */
    public function invoice_content_listAction() {
