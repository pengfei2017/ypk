...
class StoreVrOrderController extends BaseSellerController
{
    public function initialize()
    {
        parent::initialize();
        getTranslation('member_store_index,member_layout');
    }
    ...
    public function indexAction()
    {
        ...
        $this->view->render('store_vr_order', 'store_vr_order_index');
        $this->view->disable();
    }
    ...
    public function show_orderAction()
    {
        ...
        $this->view->render('store_vr_order', 'store_vr_order_show');
        $this->view->disable();
    }
    ...
    private function _order_cancel($order_info, $post)
    {
        if (!chksubmit()) {
            ...
            $this->view->render('store_vr_order', 'store_vr_order_cancel');
            $this->view->disable();
            exit();
        } else {
            $model_vr_order = Model('vr_order');
    ...
    public function exchangeAction()
    {
        if (chksubmit()) {
            ...
            $this->view->render('store_vr_order', 'store_vr_order_exchange');
            $this->view->disable();
        }
    }
    ...
    private function _exchange()
    {
        ...
        if (empty($vr_code_info) || $vr_code_info['store_id'] != getSession('store_id')) {
    ...
    private function profile_menu($menu_type = '', $menu_key = '')
    {
        switch ($menu_type) {
            case 'list':
                $menu_array = array(
                    array('menu_key' => 'store_order', 'menu_name' => getLang('nc_member_path_all_order'), 'menu_url' => getUrl('shop/store_vr_order')),
                    array('menu_key' => 'state_new', 'menu_name' => getLang('nc_member_path_wait_pay'), 'menu_url' => getUrl('shop/store_vr_order/index', array('state_type' => 'state_new'))),
                    array('menu_key' => 'state_pay', 'menu_name' => '已付款', 'menu_url' => getUrl('shop/store_vr_order/index', array('state_type' => 'state_pay'))),
                    array('menu_key' => 'state_success', 'menu_name' => getLang('nc_member_path_finished'), 'menu_url' => getUrl('shop/store_vr_order/index', array('state_type' => 'state_success'))),
                    array('menu_key' => 'state_cancel', 'menu_name' => getLang('nc_member_path_canceled'), 'menu_url' => getUrl('shop/store_vr_order/index', array('state_type' => 'state_cancel'))),
                );
                break;
            case 'exchange':
                $menu_array = array(
                    ...
                    array('menu_key' => 'state_success', 'menu_name' => getLang('nc_member_path_finished'), 'menu_url' => getUrl('shop/store_vr_order/index', array('state_type' => 'state_success'))),
                    array('menu_key' => 'state_cancel', 'menu_name' => getLang('nc_member_path_canceled'), 'menu_url' => getUrl('shop/store_vr_order/index', array('state_type' => 'state_cancel'))),
                    array('menu_key' => 'exchange', 'menu_name' => '兑换码兑换', 'menu_url' => getUrl('shop/store_vr_order/exchange')),
                );
                break;
        }
