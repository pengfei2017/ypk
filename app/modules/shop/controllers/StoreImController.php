...
class StoreImController extends BaseSellerController
{
    ...
    public function indexAction()
    {
        ...
        $this->view->pick('store_im/store_chat_index');
    }
    ...
    public function get_chat_logAction()
    {
        ...
        $this->view->pick('store_im/store_chat_log');
    }
    ...
    public function get_user_listAction()
    {
        ...
        $this->view->setRenderLevel(View::LEVEL_ACTION_VIEW);
        $this->view->pick('store_im/store_chat_user');
    }
    ...
    private function profile_menu($menu_type, $menu_key = '')
    {
        ...
        switch ($menu_type) {
            case 'im':
                $menu_array = array(
                    array('menu_key' => 'index', 'menu_name' => '聊天记录查询', 'menu_url' => getUrl('shop/store_im/index'))
                );
                break;
        }
