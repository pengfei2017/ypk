...
class MemberReturnController extends BaseMemberController
{
    ...
    public function indexAction()
    {
        ...
        $this->view->render('member_return', 'member_return');
        $this->view->disable();
    }
    ...
    public function shipAction()
    {
        ...
        if (chksubmit()) {
            ...
            if ($state) {
                showDialog(getLang('nc_common_save_succ'), getUrl('shop/member_return/index'), 'succ');
            } else {
        ...
        $this->view->render('member_return', 'member_return_view');
        $this->view->disable();
    }
    ...
    public function delayAction()
    {
        ...
        $this->view->render('member_return', 'member_return_delay');
        $this->view->disable();
    }
    ...
    public function viewAction()
    {
        ...
        $return = $return_list[0];
        Tpl::output('return', $return);
        $express_list = read_db_cache('express', true);
    ...
    private function profile_menu($menu_type, $menu_key = '')
    {
        ...
        switch ($menu_type) {
            case 'member_order':
                $menu_array = array(
                    array('menu_key' => 'buyer_refund', 'menu_name' => getLang('nc_member_path_buyer_refund'), 'menu_url' => getUrl('shop/member_return')),
