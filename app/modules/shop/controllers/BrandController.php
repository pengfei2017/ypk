...
class BrandController extends BaseHomeController
{
    ...
    public function initialize()
    {
        parent::initialize();
        //读取语言包
        getTranslation('home_brand_index,home_index_index,home_layout,member_groupbuy,common');
    ...
    public function indexAction()
    {
        ...
        $nav_link = array(
            ...
            1 => array(
                'title' => getLang('brand_index_all_brand')
            )
        );
        ...
        Tpl::output('html_title', getLang('brand_index_brand_list'));
    ...
    {
        $lang = getTranslation('home_brand_index');
        /**
         * 验证品牌
         */
        ...
        $this->view->render('brand', 'brand_goods');
        $this->view->disable();
    }
}