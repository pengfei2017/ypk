...
class StoreReturnController extends BaseSellerController
{
    ...
    public function indexAction() {
        ...
        $this->view->pick('store_return/store_return');
    }
    /**
     * 退货审核页
     *
    ...
    public function editAction() {
        ...
        if (chksubmit()) {
            $reload = getUrl('shop/store_return',array('lock'=>1));
            if ($return['order_lock'] == '2') {
                $reload = getUrl('shop/store_return',array('lock'=>2));
            }
            ...
            if ($state) {
                ...
                $param['param'] = array(
                    'refund_url' => getUrl('shop/member_return/view', array('return_id' => $return['refund_id'])),
        ...
        $this->view->pick('store_return/store_return_edit');
    }
    /**
     * 收货
     *
    ...
    public function receiveAction() {
       ...
       // Tpl::showpage('store_return_receive','null_layout');
        $this->view->pick('store_return/store_return_receive');
    }
    /**
     * 退货记录查看页
     *
    ...
    public function viewAction() {
        ...
        $this->view->pick('store_return/store_return_view');
    }
    /**
     * 用户中心右边，小导航
     *
    ...
    private function profile_menu($menu_type,$menu_key='') {
        ...
        switch ($menu_type) {
            case 'return':
                $menu_array = array(
                    array('menu_key'=>'2','menu_name'=>'售前退货',  'menu_url'=>getUrl('shop/store_return/index',array('lock'=>2))),
                    array('menu_key'=>'1','menu_name'=>'售后退货','menu_url'=>getUrl('shop/store_return/index',array('lock'=>1)))
                );
                break;
        }
