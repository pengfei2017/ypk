...
class CompareController extends BaseHomeController
{
...
//        Tpl::showpage('compare');
        ...
        $this->view->pick('compare/compare');
    }
    ...
    public function showcompareAction()
    {
        ...
        $this->view->setRenderLevel(View::LEVEL_ACTION_VIEW);
        $this->view->pick('compare/compare_mini');
    }

    /**
     * 获得已加入对比的商品ID
     */
    public function checkcompareAction()
    {
        $gids = cookie('comparegoods');
        $gid_arrtmp = $gids ? explode(',', $gids) : array();
        $gid_arr = array();
     ...
     * 清除对比栏
     */
    public function delcompareAction()
    {
